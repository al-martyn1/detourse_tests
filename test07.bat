...
@set TEST07=%BIN_ROOT%\test07.exe

@if exist %BIN_ROOT%\..\Debug\injected_test07_dll.dll    del %BIN_ROOT%\..\Debug\injected_test07_dll.dll
@if exist %BIN_ROOT%\..\Release\injected_test07_dll.dll  del %BIN_ROOT%\..\Release\injected_test07_dll.dll

@%TEST07%

@rem F:\_github\detourse_tests\_3dp\uwp-injector\build\injector.exe WhatsApp.exe F:\_github\detourse_tests\.out\msvc2019\x64\Debug\test07_dll.dll