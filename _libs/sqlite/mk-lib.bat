...
%LIB%
%LIB% /MACHINE:X64 /def:e_sqlite3.def /out:..\..\.out\msvc2019\x64\Debug\e_sqlite3.lib
%LIB% /MACHINE:X64 /def:e_sqlite3.def /out:..\..\.out\msvc2019\x64\Release\e_sqlite3.lib